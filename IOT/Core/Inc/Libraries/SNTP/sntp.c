...
tstamp changedatetime_to_seconds(datetime date)
{
	tstamp seconds=0;
	...
	seconds = (total_day+date.dd-1)*24*3600;
	seconds += date.ss;//seconds
	seconds += date.mm*60;//minute
	seconds += date.hh*3600;//hour
